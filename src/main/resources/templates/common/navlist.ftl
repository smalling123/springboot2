<div class="col-md-12 green" >
	...
	<ul class="nav navbar-nav navbar-right moredeep">
		...
		<a href="#" class="green-none white" data-toggle="dropdown">
				<img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1576819827008&di=2412142285eced1b06d5af7d5514573e&imgtype=0&src=http%3A%2F%2Fb-ssl.duitang.com%2Fuploads%2Fitem%2F201705%2F30%2F20170530205333_Fz5K4.jpeg" class="user-image" /> <span>${user.userName}</span>
		</a> <!--设置点击按钮弹出用户面板层-->
